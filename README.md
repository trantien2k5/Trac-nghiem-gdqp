...
Ứng dụng web (single-page, không cần build) để ôn tập trắc nghiệm Giáo dục quốc phòng và an ninh — có chế độ Luyện tập (tự động lặp lại câu sai, ưu tiên câu chưa thuộc) và Thi thử (tính giờ).
...
docs/           Tài liệu PDF gốc, chỉ để tham khảo/trích xuất, không dùng lúc chạy app
```
